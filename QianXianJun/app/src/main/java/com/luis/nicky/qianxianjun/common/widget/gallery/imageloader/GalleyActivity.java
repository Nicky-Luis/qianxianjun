...
import com.luis.nicky.qianxianjun.common.basic.BaseActivityWithTopBar;
...
public class GalleyActivity extends BaseActivityWithTopBar implements
	...
	@InjectView(R.id.gridView_galley)
	 GridView mGirdView;
	// 完成按钮
	@InjectView(R.id.base_ll_right_btns)
